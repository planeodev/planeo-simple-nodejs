...
helm.sh/chart: {{ include "simple-nodejs.chart" . }}
{{ include "simple-nodejs.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "simple-nodejs.fullname" .) .Values.serviceAccount.name }}
{{- else }}
